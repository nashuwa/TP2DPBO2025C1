...
function addProduk($id, $name, $kategori, $harga, $stok, $jenis, $bahan, $warna, $untuk, $size, $merk, $foto) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($_FILES["foto"]["tmp_name"], $target_file)) {
        ...
        addProduk($id, $name, $kategori, $harga, $stok, $jenis, $bahan, $warna, $untuk, $size, $merk, $target_file);
