...
public class Main {
    ...
    public static void addProduk(int id, String name, String kategori, int harga, String jenis, String bahan, String warna, String untuk, String size, String merk, boolean input) {
        // Membuat objek Baju
    ...
    public static void showProduk() {
        ...
        int maxId = 2, maxName = 4, maxKategori = 8, maxHarga = 5;
        ...
        printLine(maxId, maxName, maxKategori, maxHarga, maxJenis, maxBahan, maxWarna, maxUntuk, maxSize, maxMerk);
        printRow("ID", "Nama", "Kategori", "Harga", "Jenis", "Bahan", "Warna", "Untuk", "Size", "Merk",
                maxId, maxName, maxKategori, maxHarga, maxJenis, maxBahan, maxWarna, maxUntuk, maxSize, maxMerk);
        printLine(maxId, maxName, maxKategori, maxHarga, maxJenis, maxBahan, maxWarna, maxUntuk, maxSize, maxMerk);
    ...
    private static void printRow(String id, String name, String kategori, String harga, String jenis, String bahan,
            String warna, String untuk, String size, String merk,
            int maxId, int maxName, int maxKategori, int maxHarga,
        ...
        System.out.printf("| %-" + maxId + "s | %-" + maxName + "s | %-" + maxKategori + "s | %-" + maxHarga + "s "
                + "| %-" + maxJenis + "s | %-" + maxBahan + "s | %-" + maxWarna + "s | %-" + maxUntuk + "s "
                + "| %-" + maxSize + "s | %-" + maxMerk + "s |\n",
                id, name, kategori, harga, jenis, bahan, warna, untuk, size, merk);
    }
    ...
    public static void main(String[] args) {
        ...
        addProduk(1, "hohoho", "Aksesoris", 10000, "Baju", "Polyester", "Merah", "Kucing", "L", "yoy",
                false);
        addProduk(2, "hahaha", "Aksesoris", 20000, "Baju", "Katun", "Pink", "Anjing", "M", "yay", false);
        ...
        addProduk(4, "hehehe", "Aksesoris", 40000, "Baju", "Katun Jepang", "Ungu", "Ikan", "XS", "yey",
                false);
        addProduk(5, "huhuhu", "Aksesoris", 500000, "Baju", "Wol", "Hijau", "Domba", "XL", "yuy", false);
